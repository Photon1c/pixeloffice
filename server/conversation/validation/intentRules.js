...
exports.checkIntentRules = checkIntentRules;
var ASK_INTERROGATIVES = /\b(who|what|why|how|when|where|does|did|is|are|can|could|should|would|do|has|have|will)\b/i;
var AGREE_SIGNALS = /\b(yeah|yes|true|exactly|good point|i agree|totally|absolutely|certainly|right|definitely|for sure)\b/i;
var URGENCY_SIGNALS = /\b(should|need to|must|important|serious|urgent|right now|asap|quick|critical|immediately|have to|gotta|better)\b/i;
var DISAGREE_SIGNALS = /\b(not sure|don't think|disagree|differently|actually|but|however|no|nah|doubt|wouldn't say)\b/i;
function checkIntentRules(intent, text) {
    switch (intent) {
        case "ask":
