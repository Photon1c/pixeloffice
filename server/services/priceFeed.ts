...
export async function fetchCurrentPrice(symbol: string): Promise<PriceResult | null> {
  try {
...
export async function fetchPriceForDate(symbol: string, date: string): Promise<PriceResult | null> {
  try {
